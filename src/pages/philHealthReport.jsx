...
const ReportLayout = forwardRef((props, ref) => {
  return (
    <div
      ref={ref}
      className="w-[794px] h-[1123px] px-[60px] py-[40px] flex flex-col font-[Arial] uppercase text-[10px] text-black bg-white leading-[1.2] relative "
    >
      <div className="flex items-center justify-start">
        ...
        <div className="flex flex-col items-start justify-center ml-[-25px]">
          ...
          <h2 className=" text-semibold text-[9px]">
            3325, Baligatan, City of Ilagan
          </h2>
        </div>
      </div>
      ...
      <div className="w-full flex items-center justify-between mt-5">
        ...
        <div className="w-[230px] flex flex-col items-start justify-center text-[9px] font-medium text-justify">
          NOTE: Summary of 12 dialysis patients and treatments. Includes
          procedures, supplies, and professional fees. Amounts are provisional
          and subject to verification.
        </div>
      </div>

      <div className="w-full flex items-center font-bold justify-start mt-4 text-[10px]  ">
        {" "}
        Provisional Bill{" "}
      </div>
      ...
      <div className="w-full flex items-center font-semibold justify-start mt-2 text-[10px]  ">
        {" "}
        Detailed Breakup{" "}
      </div>
